      ...
      <div className="px-4 py-3 border-b border-[#1a1a1a]">
        <div className="relative">
          ...
          <input 
            ...
            className="w-full bg-[#161616] border border-[#1a1a1a] rounded-xl py-2.5 pl-10 pr-4 text-sm text-white placeholder:text-gray-500 focus:outline-none focus:border-[#BF953F] transition-colors"
          />
        </div>
      </div>
